...
> AI-powered protein structure prediction using Chai-1 model, available as both standalone scripts and Model Context Protocol (MCP) server for Claude Code and Gemini CLI
