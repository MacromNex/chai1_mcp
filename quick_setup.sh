#!/bin/bash
#===============================================================================
# Chai-1 MCP Quick Setup Script
#===============================================================================
# This script sets up the complete environment for Chai-1 MCP server.
#
...
echo -e "${BLUE}"
echo "=============================================="
echo "       Chai-1 MCP Quick Setup Script         "
echo "=============================================="
echo -e "${NC}"
...
if [ "$SKIP_ENV" = true ]; then
    ...
    "${ENV_DIR}/bin/pip" install chai_lab==0.6.1
...
echo "  claude mcp add chai1 -- ${ENV_DIR}/bin/python ${SCRIPT_DIR}/src/server.py"
echo ""
